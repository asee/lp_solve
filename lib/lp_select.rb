...
class LPSelect
  ...
  CONSTRAINT_ROW = {:name => "", :vars => [], :op => nil, :target => nil} #our own little format
	...
	# corresponding to variables, or by passing a YAML file or string that
  ...
  def initialize(opts = {})
    ...
    # The objective is the overall equation to solve, eg, the minimum
    # sum of each boolean variable (possibly with weights)
